...
class New extends StatelessWidget {
  ...
  @override
  State<New> createState() => _Newagenda();
}

class _Newagenda extends State<New> {
  var _isObscure = true;
  final _formKey = GlobalKey<FormState>();

  final name_agendaController = TextEditingController();
  final email_agendaController = TextEditingController();
  final telefone_agendaController = MaskedTextController(mask: "(00) 0000-0000");
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async{
          if (_formKey.currentState!.validate()) {
            ...
            final result = await ContactRepository.insertContact(agenda);
            String message;
            if (result != 0) {
